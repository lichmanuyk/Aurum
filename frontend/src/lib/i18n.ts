...
const ru = {
  ...
  "summaryCurrency.label": "Валюта сводки",
  "summaryCurrency.primary": "Основная ({{currency}})",
  "summaryCurrency.hint": "Только отображение · суммы на счетах и операции не меняются",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "quotes.retry": "Retry",
  "summaryCurrency.label": "Summary currency",
  "summaryCurrency.primary": "Primary ({{currency}})",
  "summaryCurrency.hint": "Display only · account amounts and transactions stay unchanged",
