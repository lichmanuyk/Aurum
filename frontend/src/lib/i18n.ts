...
const ru = {
  ...
  "quotes.fxHint": "Даты публикаций справочных курсов для оценки в {{currency}}. Фактические суммы переводов не меняются.",
  "quotes.noFx": "Для текущих валют счетов и активов пересчёт не нужен.",
  "quotes.missing": "Нет подтверждённых данных",
  "quotes.fx.current": "Публикация на сегодня",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "quotes.fxHint": "Reference rate publication dates for valuation in {{currency}}. Actual transfer amounts are unchanged.",
  "quotes.noFx": "Current account and asset currencies need no conversion.",
  "quotes.missing": "No confirmed data",
  "quotes.fx.current": "Published today",
