...
const ru = {
  ...
  "quotes.crypto.current": "С момента полного обновления прошло менее 24 часов.",
  "quotes.crypto.stale": "Цены устарели: полное обновление было более 24 часов назад. Показаны сохранённые оценки.",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "quotes.crypto.current": "The last full refresh was less than 24 hours ago.",
  "quotes.crypto.stale": "Prices are stale: the last full refresh was over 24 hours ago. Saved valuations are shown.",
