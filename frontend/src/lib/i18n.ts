...
const ru = {
  ...
  "dashboard.noExpensesThisMonth": "Нет расходов за выбранный период. Добавьте первую транзакцию на вкладке «Транзакции».",
  ...
  "dashboard.allMonths": "Все месяцы",
  "fxOverview.title": "Курсы валют",
  "fxOverview.noRate": "нет курса",
  "fxOverview.loadError": "Не удалось загрузить курсы",
  "fxOverview.insufficientHistory": "Недостаточно истории",
  "fxOverview.loadPeriodRates": "Загрузить курсы за период",
  "fxOverview.loadingPeriodRates": "Загрузка курсов…",
  "fxOverview.loadingRange": "Загрузка: {{range}}",
  "fxOverview.loadRatesError": "Не удалось загрузить курсы за период",
  "fxOverview.periodAverage": "среднее за период",
  "fxOverview.ytdAverage": "среднее с начала года",
  ...
  "quotes.autoFailed": "Не удалось автоматически обновить валютные курсы. Используются сохранённые курсы; повторим попытку.",
  "quotes.autoIncomplete": "NBP не вернул курсы некоторых валют. Для них используются доступные сохранённые курсы.",
  "quotes.details": "Подробнее в настройках",
  "quotes.retry": "Повторить",
  "summaryCurrency.viewInAction": "Показать в {{currency}}",
  "quotes.title": "Свежесть курсов",
  "quotes.statusError": "Не удалось проверить свежесть курсов. Сохранённые оценки могут быть устаревшими.",
  "quotes.fxHint": "Оценка на {{date}} в {{currency}}: даты публикаций справочных курсов. Фактические суммы переводов не меняются.",
  "quotes.noFx": "Для текущих валют счетов и активов пересчёт не нужен.",
  "quotes.missing": "Нет подтверждённых данных",
  "quotes.fx.current": "Публикация на дату оценки",
  "quotes.fx.previous": "Предыдущая публикация (до 7 дней); это допустимо, в том числе в выходные",
  "quotes.fx.missing": "Нет доступного курса за последние 7 дней",
  "quotes.savedAt": "Записано в Aurum: {{time}}",
  "quotes.updating": "Обновление…",
  "quotes.updateFx": "Обновить курсы NBP",
  "quotes.fxDone": "Загрузка завершена. Показаны даты доступных публикаций; ручные курсы сохранены.",
  "quotes.fxFailed": "Не удалось загрузить курсы NBP. Ранее сохранённые курсы не изменены. Повторите обновление.",
  "quotes.cryptoTime": "Последнее полное обновление цен криптовалют",
  "quotes.crypto.current": "С момента полного обновления прошло менее часа.",
  "quotes.crypto.stale": "Цены устарели: полное обновление было более часа назад. Показаны сохранённые оценки.",
  "quotes.crypto.missing": "Свежесть всех цен не подтверждена. Сохранённые оценки могут быть устаревшими.",
  "quotes.crypto.empty": "Нет криптовалют",
  "quotes.cryptoFailed": "Обновление не удалось. Показаны сохранённые оценки.",
  "quotes.cryptoDone": "Цены всех монет обновлены.",
  "crypto.syncError.incomplete": "Получены цены не всех монет. Для остальных сохранены прежние значения; полное обновление не подтверждено.",
  ...
  "transactions.import.transferAccountColumn": "Колонка счёта-получателя перевода",
  "transactions.import.destinationAmountColumn": "Колонка фактически полученной суммы",
  "transactions.import.ambiguousTransfer": "перевод не импортирован: нужен другой счёт и, при разных валютах, фактически полученная сумма",
  ...
  "transactions.sortAmountDesc": "Исходная сумма: сначала больше",
  "transactions.sortAmountAsc": "Исходная сумма: сначала меньше",
  ...
  "transactions.form.typeAdjustment": "Корректировка баланса",
  "transactions.adjustmentReason": "Причина",
  "transactions.openingBalance": "Начальный остаток",
  "transactions.reconciliation": "Сверка остатка",
  "transactions.migration": "Перенос истории",
  "transactions.adjustmentHint": "Укажите изменение остатка: положительное для увеличения, отрицательное для уменьшения. Не учитывается в доходах и расходах.",
  ...
  "settings.currencyHint": "Валюта отчётов. Исходные суммы не меняются; отчёты используют исторические курсы.",
  "settings.displayCurrency": "Валюта отображения сводок",
  "settings.displayCurrencyGeneralLabel": "Общая",
  "settings.displayCurrencyHint": "Затрагивает только Дашборд, Капитал и Криптовалюту — валюта учёта и реальные суммы остаются прежними.",
  "settings.displayCurrencyInherit": "Как в общей настройке",
  "settings.dashboardCurrencyLabel": "Дашборд",
  "settings.netWorthCurrencyLabel": "Капитал",
  "settings.cryptoCurrencyLabel": "Криптовалюта",
  ...
  "goal.reserved": "Из них зарезервировано на счетах: {{amount}}",
  ...
  "goal.contribution.accountLabel": "Счёт с деньгами для цели",
  "goal.contribution.chooseAccount": "Выберите счёт в валюте цели",
  "goal.contribution.available": "доступно",
  "goal.contribution.hint": "Деньги останутся на счёте, но уменьшат доступную сумму. Отрицательная сумма снимет резерв с этой цели.",
  "goal.contribution.saveError": "Не удалось сохранить взнос. Проверьте данные и попробуйте снова.",
  "account.reserved": "На цели",
  ...
  "category.deleteBlocked": "Категорию можно удалить, когда она и её подкатегории не используются в операциях, бюджетах и регулярных платежах.",
...
const en: Record<keyof typeof ru, string> = {
  ...
  "dashboard.noExpensesThisMonth": "No expenses for the selected period. Add your first transaction on the Transactions tab.",
  ...
  "fxOverview.insufficientHistory": "Not enough history",
  "fxOverview.loadPeriodRates": "Load rates for this period",
  "fxOverview.loadingPeriodRates": "Loading rates…",
  "fxOverview.loadingRange": "Loading: {{range}}",
  "fxOverview.loadRatesError": "Couldn't load rates for this period",
  "fxOverview.periodAverage": "period average",
  "fxOverview.ytdAverage": "average since start of year",
  ...
  "quotes.autoFailed": "Automatic exchange rate refresh failed. Saved rates remain in use; we will retry.",
  "quotes.autoIncomplete": "NBP did not return some currencies. Available saved rates remain in use for them.",
  "quotes.details": "Details in settings",
  "quotes.retry": "Retry",
  "summaryCurrency.viewInAction": "Show in {{currency}}",
  "quotes.title": "Quote freshness",
  "quotes.statusError": "Could not check quote freshness. Saved valuations may be out of date.",
  "quotes.fxHint": "Valuation on {{date}} in {{currency}}: reference rate publication dates. Actual transfer amounts are unchanged.",
  "quotes.noFx": "Current account and asset currencies need no conversion.",
  "quotes.missing": "No confirmed data",
  "quotes.fx.current": "Published on the valuation date",
  "quotes.fx.previous": "Previous publication (up to 7 days); allowed, including weekends",
  "quotes.fx.missing": "No available rate within the last 7 days",
  "quotes.savedAt": "Saved in Aurum: {{time}}",
  "quotes.updating": "Updating…",
  "quotes.updateFx": "Update NBP rates",
  "quotes.fxDone": "Download complete. Available publication dates are shown; manual rates were preserved.",
  "quotes.fxFailed": "Could not load NBP rates. Previously saved rates were not changed. Please retry.",
  "quotes.cryptoTime": "Last full crypto price refresh",
  "quotes.crypto.current": "The last full refresh was less than an hour ago.",
  "quotes.crypto.stale": "Prices are stale: the last full refresh was over an hour ago. Saved valuations are shown.",
  "quotes.crypto.missing": "Freshness of all prices is unconfirmed. Saved valuations may be out of date.",
  "quotes.crypto.empty": "No crypto holdings",
  "quotes.cryptoFailed": "Refresh failed. Saved valuations are shown.",
  "quotes.cryptoDone": "All coin prices were refreshed.",
  "crypto.syncError.incomplete": "Some coin prices were missing. Previous values were preserved; a full refresh was not confirmed.",
  ...
  "transactions.import.transferAccountColumn": "Transfer destination account column",
  "transactions.import.destinationAmountColumn": "Actual received amount column",
  "transactions.import.ambiguousTransfer": "transfer not imported: another account and, for different currencies, the actual received amount are required",
  ...
  "transactions.sortAmountDesc": "Native amount: high to low",
  "transactions.sortAmountAsc": "Native amount: low to high",
  ...
  "transactions.form.typeAdjustment": "Balance adjustment",
  "transactions.adjustmentReason": "Reason",
  "transactions.openingBalance": "Opening balance",
  "transactions.reconciliation": "Balance reconciliation",
  "transactions.migration": "History migration",
  "transactions.adjustmentHint": "Enter the balance change: positive to increase, negative to decrease. Excluded from income and expenses.",
  ...
  "settings.currencyHint": "Reporting currency. Native amounts stay unchanged; reports use historical exchange rates.",
  "settings.displayCurrency": "Summary display currency",
  "settings.displayCurrencyGeneralLabel": "General",
  "settings.displayCurrencyHint": "Only affects Dashboard, Net Worth, and Crypto — the accounting currency and real amounts stay the same.",
  "settings.displayCurrencyInherit": "Same as the general setting",
  "settings.dashboardCurrencyLabel": "Dashboard",
  "settings.netWorthCurrencyLabel": "Net Worth",
  "settings.cryptoCurrencyLabel": "Crypto",
  ...
  "goal.reserved": "Reserved in accounts: {{amount}}",
  ...
  "goal.contribution.accountLabel": "Account holding goal money",
  "goal.contribution.chooseAccount": "Choose an account in the goal currency",
  "goal.contribution.available": "available",
  "goal.contribution.hint": "Money stays in the account but reduces what is available to spend. Enter a negative amount to release this goal's reservation.",
  "goal.contribution.saveError": "Failed to save the contribution. Check the data and try again.",
  "account.reserved": "For goals",
  ...
  "category.deleteBlocked": "A category can be deleted once it and its subcategories are no longer used by transactions, budgets or recurring payments.",
